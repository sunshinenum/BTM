...
private:
  ...
  void load_words(string words_pt, map<string, string> & words_id);
  void tokenize(string const &str, const char delim, vector<string> &out);
  string index_words(string line, map<string, string> & words_id);
  string transform_dist(Pvec<double>& pz_d);
